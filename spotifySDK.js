/* Spotify JS-SDK - v1.10.0-9ac1fa8 */
...
!(function e(t, n, r) {
...
})(
  {
            ...
            !(function (n) {
              ...
              (n = function (e, n) {
                        ...
                        for (; a; )
                          try {
                            if (
                              ...
                              r &&
                                (s =
                                  2 & o[0] ? r.return : o[0] ? r.throw || ((s = r.return) && s.call(r), 0) : r.next) &&
                                !(s = s.call(r, o[1])).done)
                            )
                              return s;
                            switch (((r = 0), s && (o = [2 & o[0], s.value]), o[0])) {
                              ...
                              default:
                                if (
                                  !((s = a.trys), (s = s.length > 0 && s[s.length - 1]) || (6 !== o[0] && 2 !== o[0]))
                                ) {
                                  a = 0;
                                  continue;
                                }
                ...
                (E = function () {
                  ...
                  var r = Array(e),
                    s = 0;
                  for (t = 0; t < n; t++) for (var o = arguments[t], a = 0, i = o.length; a < i; a++, s++) r[s] = o[a];
                  return r;
                }),
                (d = function (e, t, n) {
                ...
                (g = function (e) {
                  ...
                  function r(r, s) {
                    t[r] = e[r]
                      ? function (t) {
                          return (n = !n) ? { value: y(e[r](t)), done: 'return' === r } : s ? s(t) : t;
                        }
                      : s;
                  }
                }),
    ...
    6: [
      function (e, t, n) {
        'use strict';
        Object.defineProperty(n, '__esModule', { value: !0 }), (n.PlayerError = void 0);
        var r = e('tslib'),
          s = (function (e) {
            function t(t, n) {
    ...
    7: [
      function (e, t, n) {
        ...
        function a() {
          ...
          if (((window.Spotify = { Player: o.setupPlayerEnv(window) }), window.onSpotifyWebPlaybackSDKReady))
    ...
    8: [
      function (e, t, n) {
        'use strict';
        Object.defineProperty(n, '__esModule', { value: !0 }), (n.setupPlayerEnv = void 0);
        var r = e('tslib'),
          ...
          return (function () {
            function t(t) {
              ...
              (this._options = {
                name:
                  t.name ||
                  (null === (s = null == e ? void 0 : e.location) || void 0 === s ? void 0 : s.hostname) ||
                  '',
                ...
                (this._messageHandlers =
                  (((r = {})[o.Messages.GET_TOKEN] = this._onGetToken.bind(this)),
            ...
            return (
              ...
              (t.prototype._onGetToken = function (e, t) {
                ...
                if ('function' == typeof r)
                  ...
                  this._onEvent({ name: o.Messages.PLAYER_INIT_ERROR, eventData: { message: i.Errors.INVALID_OAUTH } });
                }
              }),
              (t.prototype._onConnected = function (e) {
                var t;
                e.ref in this._connectionRequests &&
                  (null === (t = this._connectionRequests[e.ref]) || void 0 === t || t.resolve(e.connected),
                  delete this._connectionRequests[e.ref]);
              }),
              (t.prototype._onCurrentState = function (e) {
                var t;
                e.ref in this._getCurrentStateRequests &&
                  (null === (t = this._getCurrentStateRequests[e.ref]) || void 0 === t || t.resolve(e.state),
                  delete this._getCurrentStateRequests[e.ref]);
              }),
              (t.prototype._onVolume = function (e) {
                var t;
                e.ref in this._getVolumeRequests &&
                  (null === (t = this._getVolumeRequests[e.ref]) || void 0 === t || t.resolve(e.volume),
    ...
    9: [
      function (e, t, n) {
        'use strict';
        Object.defineProperty(n, '__esModule', { value: !0 }), (n.MessageDispatcher = void 0);
    ...
    10: [
      function (e, t, n) {
        'use strict';
        Object.defineProperty(n, '__esModule', { value: !0 }), (n.messages = void 0);
        var r = e('../enums/messages'),
          s = (function () {
            function e() {}
            return (
              ...
              (e.prototype._createEventMessage = function (e, t) {
                return this._createMessage(r.Messages.EVENT, { name: e, eventData: t });
              }),
              (e.prototype._createMessage = function (e, t) {
                return {
                  type: r.Messages.SPOTIFY_MESSAGE,
                  body: { topic: e, data: void 0 !== t ? JSON.parse(JSON.stringify(t)) : void 0 },
                };
              }),
              (e.prototype.accountError = function (e) {
                return this._createEventMessage(r.Messages.ACCOUNT_ERROR, { message: e });
              }),
              ...
              (e.prototype.connected = function (e, t) {
                return this._createMessage(r.Messages.CONNECTED, { connected: e, ref: t });
              }),
              ...
              (e.prototype.token = function (e, t) {
                return this._createMessage(r.Messages.TOKEN, { token: e, ref: t });
              }),
              ...
              (e.prototype.currentState = function (e, t) {
                return this._createMessage(r.Messages.CURRENT_STATE, { state: e, ref: t });
              }),
              ...
              (e.prototype.volume = function (e, t) {
                return this._createMessage(r.Messages.VOLUME, { volume: e, ref: t });
              }),
